...
問題行動は、リポジトリ管理者が指定する非公開の連絡経路へ報告してください。GitHub上で利用できる場合は、
公開Issueではなく適切な非公開機能を使用します。確認できないメールアドレスやURLは、この文書では
窓口として推測しません。安全上の緊急性がある場合は [セキュリティ方針](SECURITY.md) も参照してください。
